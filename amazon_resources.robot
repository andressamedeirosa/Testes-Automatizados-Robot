...
${HEADER_ELETRONICOS}               locator=//h1[contains(.,'Eletrônicos e Tecnologia')]
${TEXTO_HEADER_ELETRONICOS}         Eletrônicos e Tecnologia
${ADD_CARRINHO}                     //input[contains(@name,'submit.add-to-cart')]
${PRODUTO_ADICIONADO}               //span[contains(.,'Adicionado ao carrinho')]
${PRODUTO_EXCLUIDO}                 //h1[contains(.,'Seu carrinho de compras da Amazon está vazio.')]
...
Verificar se o carrinho fica vazio
    Wait Until Element Is Visible    locator=${PRODUTO_EXCLUIDO}
